    ...
    return (
        <Layout>
            ...
            <div className="blog-container">
                ...
                <p>I used an infrared camera to create a variety of real-time interactive visuals that were to be displayed on six separate "sepals" on the rose. The visuals include interactive particle rain, "drawing" with a phone flashlight, and more. I uploaded a <a href="https://github.com/benrandall/AET_Desert_Rose" target="_blank">demo repo</a> to allow people with TouchDesigner to download and run the visuals. </p>
                <img src={prototype}/>
                <br />
