        ...
        <Layout>
            ...
            <div className="blog-container">
                ...
                <div className="sp-blog-post">
                    ...
                    <p>For now, I'm deep into phase 1. I ended up deciding that the best way to run my project was to build a Windows PC with enough graphics processing power to run eight displays.  After I finished some rough budgeting on the project as a whole, Michael helped me pick appropriate parts for a PC and I ordered them shortly after. I used PC Part Picker to keep myself organized. You can view my build <a href="https://pcpartpicker.com/user/ben_randall/saved/GtqdXL" target="_blank" rel="noreferrer">here.</a></p>
                    <p>As I've never built a PC before, or even know if this whole system is going to work, I am a little anxious and excited to see where the next two weeks takes me. Once the final piece of the PC ships to me on Saturday, I will work on building the rig and immediately start testing and experimenting with displays. In about two weeks, I'm excited to test out some visual ideas and sketches at a <a href="https://www.residentadvisor.net/events/1161125" target="_blank" rel="noreferrer">event</a> I am organizing. So far, I have 4 of the ideal 8 CRT TV's in my possession and I can't wait to test them out.</p>
                </div>
                <h2>[10/01/18]</h2>
                <div className="sp-blog-post">
                    ...
                    <p>With a little tweaking, the setup worked almost immediately. I figured out later that the bottom right TV's converter was set to <a href="https://www.diffen.com/difference/NTSC_vs_PAL" target="_blank" rel="noreferrer">PAL instead of NTSC.</a></p>
